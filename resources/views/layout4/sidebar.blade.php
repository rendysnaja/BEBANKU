  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['/verifikasi/peserta']) }}">
        <a href="{{ url('/manajemen/user') }}" class="nav-link">
          <i class="link-icon" data-feather="users"></i>
          <span class="link-title">User</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/verifikasi/peserta']) }}">
        <a href="{{ url('/manajemen/unit') }}" class="nav-link">
          <i class="link-icon" data-feather="hard-drive"></i>
          <span class="link-title">Unit</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/manajemen/evaluasi']) }}">
        <a href="{{ url('/manajemen/tahun') }}" class="nav-link">
          <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Tahun</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/manajemen/evaluasi']) }}">
        <a href="{{ url('/manajemen/evaluasi') }}" class="nav-link"> 
          <i class="link-icon" data-feather="check-square"></i>
          <span class="link-title">Evaluasi</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/manajemen/laporan']) }}">
        <a href="{{ url('/manajemen/laporantahunan') }}" class="nav-link">
