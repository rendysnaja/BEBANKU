...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Ubah Kegiatan Rutinitas</li>
  </ol>
</nav>
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-header text-white bg-primary">
        <h6>Ubah Kegiatan Rutinitas</h6>
      </div>
      <div class="card-body">
        <form method="post" action="/harian/update/{{ $rutinitas->id }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="nama" id="exampleInputUsername2" value="{{ $rutinitas->rutinitas_nama }}" placeholder="Contoh kegiatan menari : menari" required="required">
              </div>
            </div>
            @if($errors->has('nama'))
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <select class="form-select" name="status" id="exampleFormControlSelect1">
                  <option value="{{ $rutinitas->rutinitas_status}}">{{ $rutinitas->rutinitas_status }}</option>
          ...
          <div class="form-group">
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="number" class="form-control" name="pelaksana" id="exampleInputMobile" value="{{ $rutinitas->rutinitas_pelaksana }}" placeholder="Contoh 2 pelaksana : 2" required="required">
              </div>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" name="lamajam" id="exampleInputUsername2" value="{{ $rutinitas->rutinitas_lamajam }}" placeholder="Contoh 1 jam : 1">
            </div>
            <label for="exampleInputUsername2" class="col-sm-1 col-form-label">Jam</label>
            <div class="col-sm-3">
              <input type="text" class="form-control" name="lamamenit" id="exampleInputUsername2" value="{{ $rutinitas->rutinitas_lamamenit }}" placeholder="Contoh 30 menit : 30">
            </div>
          ...
          <div class="row mb-3">
            ...
            <!-- <div class="col-sm-3">
              <a href="/harian/filehapus/{{ $rutinitas->id }}" class="btn btn-danger btn-icon">
