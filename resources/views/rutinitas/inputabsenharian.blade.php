...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      ...
      <div class="card-body">
        <form class="forms-sample" action="/absen/harianstore/{{ $rutinitas->id }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="d-flex justify-content-end">
            ...
            <a href="/harian/absen" class="btn btn-secondary">Cancel</a>
          </div>
        </form>
      </div>
    </div>
