...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      ...
      <div class="card-body">
        <form class="forms-sample" action="/verifikasi/store2/{{ $tambahan->id }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="nilaifte" id="exampleInputUsername2" value="{{ number_format($waktu2,2) }}" required="required" disabled>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  @if ($waktu2 < 0.99 )
                    <input type="text" class="form-control" name="kategorifte" id="exampleInputUsername2" value="Kurang" required="required" disabled>
                  @elseif ($waktu2 <= 0.99 || $waktu2 <=1.28)
                    <input type="text" class="form-control" name="kategorifte" id="exampleInputUsername2" value="Normal" required="required" disabled>
                  @elseif ($waktu2 > 1.28)
                    <input type="text" class="form-control" name="kategorifte" id="exampleInputUsername2" value="Berlebihan" required="required" disabled>
                  @endif
                </div>
              </div>
            </li>
            <li class="list-group-item">
              ...
              <div class="form-group">
                <div class="row mb-3">
                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nilai Beban Kegiatan</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="nilaiasesor" id="exampleInputUsername2" placeholder="Contoh beban kegiatan 1.28 : 1.28" required="required">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <select class="form-select" name="kategoriasesor" id="exampleFormControlSelect1">
                      <option selected disabled>Pilih Kategori Beban Kegiatan</option>
              ...
              <div class="form-group">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <textarea class="form-control" name="komentar" id="exampleFormControlTextarea1" rows="5" placeholder="Masukkan Komentar" required="required"></textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <select class="form-select" name="status" id="exampleFormControlSelect1">
                      <option selected disabled>Pilih Status Verifikasi Kegiatan</option>
