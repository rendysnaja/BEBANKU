...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" action="/manajemen/updateuser/{{ $user->id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama" id="exampleInputUsername2" placeholder="Masukan nama" value="{{ $user->name }}" required="required">
                            </div>
                            @if($errors->has('nama'))
                    ...
                    <div class="form-group">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" name="email" id="exampleInputUsername2" placeholder="Masukan email" value="{{ $user->email }}" required="required">
                            </div>
                            @if($errors->has('email'))
                            <div class="text-danger">
                                {{ $errors->first('email')}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" name="unit" id="exampleFormControlSelect1">
                                    <option value="{{ $user->unit_id }}">{{ $user->unit->unit_nama }}</option>
                                    @foreach($unit as $u)
                    ...
                    <div class="form-group">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" name="password" id="exampleInputMobile" placeholder="Masukan password">
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" name="password_confirm" id="exampleInputMobile" placeholder="Masukan kembali password">
                            </div>
