    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nama" id="exampleInputUsername2" disabled value="{{ $rutinitas->rutinitas_status }}">
          </div>
        </div>
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama" id="exampleInputUsername2" disabled value="{{ number_format($rutinitas->fterutinitas->fterutinitas_nilai,2) }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama" id="exampleInputUsername2" disabled value="{{ $rutinitas->fterutinitas->fterutinitas_kategori }}">
                      </div>
                    </div>
                  </li>
                  <li class="list-group-item">
                    ...
                    <div class="row mb-3">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nilai Beban Kegiatan</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama" id="exampleInputUsername2" disabled value="{{ number_format($rutinitas->fterutinitas->asesorrutinitas_nilai,2) }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Kategori Beban Kegiatan</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama" id="exampleInputUsername2" disabled value="{{ $rutinitas->fterutinitas->asesorrutinitas_kategori }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <textarea class="form-control" name="komentar" id="exampleFormControlTextarea1" rows="5" disabled required="required">{{ $rutinitas->fterutinitas->asesorrutinitas_komentar }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama" id="exampleInputUsername2" disabled value="{{ $rutinitas->fterutinitas->asesorrutinitas_status }}">
                      </div>
                    </div>
                  </li>
                </ul>
