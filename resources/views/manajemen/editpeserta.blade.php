...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" action="/manajemen/updateevaldetail/{{ $evaluasidetail->id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" name="unit" id="exampleFormControlSelect1">
                                    <option value="{{ $evaluasidetail->unit_id}}">{{ $evaluasidetail->unit->unit_nama}}</option>
                                    @foreach($unit as $u)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" name="asesi" id="exampleFormControlSelect1">
                                    <option value="{{ $evaluasidetail->user_id }}">{{ $evaluasidetail->user->name }}</option>
                                    @foreach($user as $u)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" name="asesor" id="exampleFormControlSelect1">
                                    <option value="{{ $evaluasidetail->asesor_id }}">{{ $evaluasidetail->asesor->user->name }}</option>
                                    @foreach($asesor as $a)
