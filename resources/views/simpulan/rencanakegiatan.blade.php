      ...
      <div class="card-body">
        ...
        <div class="tab-content mt-3" id="lineTabContent">
                  ...
                  <table id="table" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="/simpulan/detailrencana/{{ $r->id }}" class="btn btn-primary btn-icon">
                            <i data-feather="eye"></i>
                          </a>
                        </td>
                      </tr>
                  ...
                  <table id="table" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="/simpulan/detailrencana2/{{ $t->id }}" class="btn btn-primary btn-icon">
                            <i data-feather="eye"></i>
                          </a>
                        </td>
                      </tr>
          ...
          <div class="tab-pane fade" id="simpulan" role="tabpanel" aria-labelledby="simpulan-line-tab">
            ...
            <div class="card">
              <div class="card-header text-white bg-secondary">
                <h6>Simpulan Rencana Beban Kegiatan</h6>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="table" class="table">
...
<div class="d-flex justify-content-center">
  @if ($evaluasidetail->status == 2)
  <a href="/simpulan/rencanaselesai/{{ $evaluasidetail->id }}">
    <button type="button" class="btn btn-primary">Simpan Permanen</button>
  </a>
  @elseif ($evaluasidetail->status == 3)
  <a href="/simpulan/rencanaselesai/{{ $evaluasidetail->id }}">
    <button type="button" class="btn btn-secondary disabled">Rencana Kegiatan Sedang Diverifikasi</button>
  </a>
  @elseif ($evaluasidetail->status == 4)
  <a href="/simpulan/detailrencana2/{{ $t->id }}">
    <button type="button" class="btn btn-success">Evaluasi Telah Selesai</button>
  </a>
  @endif
</div>
