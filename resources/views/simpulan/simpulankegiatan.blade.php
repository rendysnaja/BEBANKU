            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <table id="table" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="/simpulan/detail/{{ $r->id }}" class="btn btn-primary btn-icon">
                            <i data-feather="eye"></i>
                          </a>
                        </td>
                      </tr>
                ...
                <div class="card-footer bg-light">
                  <p>Total nilai beban kegiatan rutinitas yang diterima = {{ number_format ($evaluasidetail->hasilevaluasi->sumasesorrutinitas,2) }}</p>
                </div>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="tambahan" role="tabpanel" aria-labelledby="tambahan-line-tab">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <table id="table" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $t->ftetambahan->asesortambahan_status }}</td>
                        <td>{{ number_format ($t->ftetambahan->asesortambahan_nilai,2) }}</td>
                        <td>
                          <a href="/simpulan/detail2/{{ $t->id }}" class="btn btn-primary btn-icon">
                            <i data-feather="eye"></i>
                          </a>
                        </td>
                      </tr>
                ...
                <div class="card-footer bg-light">
                  <p>Total nilai beban kegiatan tambahan yang diterima = {{ number_format ($evaluasidetail->hasilevaluasi->sumasesortambahan,2) }}</p>
                </div>
            </div>
          </div>
