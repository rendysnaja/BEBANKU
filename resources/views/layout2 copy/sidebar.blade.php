<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item nav-category">Kehadiran</li>
      <li class="nav-item {{ active_class(['/tabelizin/harian']) }}">
        <a href="{{ url('/tabelizin') }}" class="nav-link">
          <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Izin dan Cuti</span>
        </a>
      </li>
      <li class="nav-item nav-category">Rekap Kegiatan</li>
      <!-- <li class="nav-item {{ active_class(['email/*']) }}">
        ...
        <div class="collapse {{ show_class(['email/*']) }}" id="email">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/harian') }}" class="nav-link {{ active_class(['email/inbox']) }}">Harian</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/email/read') }}" class="nav-link {{ active_class(['email/read']) }}">Tambahan</a>
            </li>
          </ul>
        </div>
      </li> -->
      <li class="nav-item {{ active_class(['/harian']) }}">
        <a href="{{ url('/harian') }}" class="nav-link">
          <i class="link-icon" data-feather="file-text"></i>
          <span class="link-title">Rutinitas</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/tambahan']) }}">
        <a href="{{ url('/tambahan') }}" class="nav-link">
          <i class="link-icon" data-feather="file-plus"></i>
          <span class="link-title">Tambahan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/simpulan/tabelsimpulan']) }}">
        <a href="{{ url('/simpulan/tabelsimpulan') }}" class="nav-link">
          <i class="link-icon" data-feather="clipboard"></i>
          <span class="link-title">Simpulan</span>
        </a>
      </li>
      <!-- <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/app/calendar') }}" class="nav-link">
          <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Laporan Beban Kerja</span>
        </a>
      </li> -->
      <li class="nav-item nav-category">Evaluasi Beban Kerja</li>
      <li class="nav-item {{ active_class(['/verifikasi/peserta']) }}">
        <a href="{{ url('/verifikasi/peserta') }}" class="nav-link">
          <i class="link-icon" data-feather="check-square"></i>
          <span class="link-title">Verifikasi Kegiatan</span>
        </a>
      </li>
      <!-- <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/harian') }}" class="nav-link">
      ...
      <!-- <li class="nav-item {{ active_class(['ui-components/*']) }}">
        ...
        <div class="collapse {{ show_class(['ui-components/*']) }}" id="uiComponents">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/ui-components/accordion') }}" class="nav-link {{ active_class(['ui-components/accordion']) }}">laporan</a>
            </li>
            <li class="nav-item">
